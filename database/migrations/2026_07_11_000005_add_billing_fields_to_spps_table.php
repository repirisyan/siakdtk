...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('spps', function (Blueprint $table) {
            ...
            $table->dropUnique('spps_siswa_id_thn_ajaran_unique');
            ...
            $table->unique(['siswa_id', 'jenis_pembayaran', 'tanggal_tagihan'], 'spps_student_bill_unique');
        });
    }
    ...
    {
        Schema::table('spps', function (Blueprint $table) {
            $table->dropUnique('spps_student_bill_unique');
            $table->unique(['siswa_id', 'thn_ajaran']);
            $table->dropIndex('spps_siswa_id_index');
