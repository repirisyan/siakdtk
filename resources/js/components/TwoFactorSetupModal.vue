...
const modalConfig = computed<TwoFactorConfigContent>(() => {
    if (props.twoFactorEnabled) {
        return {
            ...
            description:
                'Verifikasi dua langkah telah aktif. Pindai kode QR atau masukkan kunci pengaturan pada aplikasi autentikator Anda.',
            buttonText: 'Tutup',
        };
    }
    ...
    return {
        ...
        description:
            'Untuk menyelesaikan pengaturan, pindai kode QR atau masukkan kunci pengaturan pada aplikasi autentikator Anda.',
        buttonText: 'Lanjutkan',
    };
});
